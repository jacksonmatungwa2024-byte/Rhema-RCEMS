...
export default function UsagePanel() {
 ...
 return (
  <div className="container" ref={panelRef}>
    <div className="heading">📊 Matumizi ya Hifadhi</div>

    {alert && <div className="alert">⚠️ Zaidi ya 80% ya hifadhi imetumika!</div>}

    <div className="bar">
      <div className="fill" style={{ width: `${percentUsed}%` }} />
    </div>
    <div className="paragraph">
      <strong>{usedGB} GB</strong> zimetumika · <strong>{remainingGB} GB</strong> zimebaki
    </div>
    <div className="paragraph">{percentUsed}% ya hifadhi imetumika</div>

    <div className="subheading">📁 Matumizi kwa Tukio</div>
    <Pie data={pieData} />

    <div className="subheading">📈 Historia ya Matumizi</div>
    <Line data={lineData} />

    <button className="exportBtn" onClick={exportPDF}>📄 Pakua PDF</button>
  </div>
)
}