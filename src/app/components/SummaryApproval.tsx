...
export default function SummaryApproval() {
  ...
  return (
  <div className="summary-approval-container">
    <h3>📋 Muhtasari Wanaosubiri Idhini</h3>
    {summaries.length === 0 ? (
      <p className="message">Hakuna muhtasari wa kuidhinishwa kwa sasa</p>
    ) : (
      summaries.map((s) => (
